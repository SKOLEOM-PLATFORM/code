...
session_start();
if($_SESSION["id"] && $_SESSION["username"] && $_SESSION["usermail"]   ) {
    
  $_SESSION["id"];  $_SESSION["username"]; $_SESSION["usermail"];
...
<head>
  ...
  <title>Skoleom Dashboard Panel</title>
  <!-- loader-->
 ...
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper-->
   ...
   <ul class="sidebar-menu do-nicescrol">
      <li class="sidebar-header">POP UP ONE</li>
      <li>
        <a href="assetsone.php">
          <i class="zmdi zmdi-view-dashboard"></i> <span>Asset One</span>
        </a>
      </li>
       ...
       <li class="dropdown-item user-details">
        <a href="javaScript:void();">
           <div class="media">
            ...
            <p class="user-subtitle"><?php echo  $_SESSION["usermail"]; ?></p>
            </div>
           </div>
          </a>
        </li>
