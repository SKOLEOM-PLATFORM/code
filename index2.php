        ...
        <div class="bg_vid_main_div" style="width: 53%; position: relative!important;">
            <div class="bg_vid_sub_div" style="position: relative!important;">
                ...
                <div id="htmlpage"
                    ...
                    <iframe style="border: none;" name="pagehtml" src="./dashboard/signin.php" height="100%"
                        width="100%" title="W3Schools Free Online Web Tutorials"></iframe>
                ...
                <div id="page"
                    style="display: none; border: 20px solid #C66800; position: absolute; top: 0; left: 0; width: 100%; height: 100%;  z-index: 20;">
                    <iframe style="border: none;" name="Webpage" src="" height="100%" width="100%"
                        title="W3Schools Free Online Web Tutorials"></iframe>
                    <i class="fa fa-close" style="font-size:32px; color: #2C346B; position: absolute;
    top: -5%;
    right: -2%; z-index: 22;" onclick="webPagePreview()"></i>
                </div>
                ...
                <div class="elementor-video" onclick="closeAll()">
                    ...
                    <video controls crossorigin playsinline id="player">
                        <!-- Video files -->
                        <source src="./assets/Fiber-fever-teaser.mp4" type="video/mp4" size="576">
                ...
                <div id="loading_div" style="display: none;">
                 ...
                 include 'config.php';               
 $sql = "SELECT * FROM duplicate_assetsone";
$result = $db->query($sql);
...
if ($result->num_rows > 0) {
  ...
  $song_name =  $row["song_name"];
   $feat =  $row["feat"];
                                ...
                                ?>
                                <img class='prfile_props' src="./assets/index2/<?php echo $file ?>" id="profilePly" alt=""> 
                        ...
                        <div class="section" id="option1">
                            <a style="cursor: pointer; height:100%; text-align: center;"
                                href="https://www.youtube.com/embed/A9TczekUE3M" target="youtubeVideo">
                                ...
                                <img src="./assets/t.jpg" alt="" class="hamilton initial_class">
                        ...
                        <div class="section" id="option2" style="margin-bottom: 3px;">
                            <!-- <img src="./assets/cart.png" alt="" class="tv"> -->
                            <a style="cursor: pointer; text-align: center; height: 100%; " href="./dashboard/signin.php"
                                target="pagehtml">
                                ...
                                <img src="./assets/3.png" alt="" style="margin-top: -3px;"
                                    class="hamilton initial_class">
                                <img src="./assets/index2/index2q.html" alt="" style="display:none; margin-top: -3px;"
                                    class="hamilton change_class">
                                <p>Take an appointment <br> on an Orange
                                </p>
                            </a>
                        </div>
                        <div class="section" style="position: relative;" id="option3">
                            <a style="cursor: pointer; text-align: center; height: 100%;"
                                ...
                                target="Webpage">
                                <img src="./assets/i.png" alt="" class="tv">
                                <img src="./assets/story.png" alt="" class="hamilton initial_class">

                                <img src="./assets/index2/index2r.html" alt="" class="hamilton change_class"
                                    style='display:none;'>

                                <p>Incredible story on : <br>
                                    Good News
                                </p>
                            </a>
                        </div>
                    ...
                    <div class="profiles" id="profile_overflow">
                        ...
                        <div id="style-4">
                            <img src="./assets/04.webp" width="40" height="40" class="profile_list">
                            <img src="./assets/01.webp" width="40" height="40" class="profile_list">
                            <img src="./assets/03.png" width="40" height="40" class="profile_list">
                            <img src="./assets/04.webp" width="40" height="40" class="profile_list">
                            <img src="./assets/Afif-Bahnasi.png" width="40" height="40" class="profile_list">
                            <img src="./assets/Airbnb_Logo_Bélo.svg.png" width="40" height="40" class="profile_list">
                        </div>
                    </div>
